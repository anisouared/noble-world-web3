    ...
    <Dialog>
        ...
        <Card className="hover:shadow-[0_1px_10px_rgba(0,0,0,0.7)] transition-shadow w-full sm:w-auto overflow-hidden mb-2">
          <CardHeader className="p-4 pb-3">
            <div className="relative aspect-square rounded-lg overflow-hidden mb-2">
              <img src={product.imagePath} alt={product.title} className="object-cover w-full h-full" />
            </div>
          ...
          <CardContent className="p-4 pt-0 pb-3">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-semibold">{product.priceInWei}</span>
            </div>
          </CardContent>
        </Card>
      </DialogTrigger>
      <DialogContent className="p-6 flex flex-col md:max-w-[800px]">
        <DialogHeader className="flex justify-between items-center">
          ...
          <DialogDescription className="pr-3 pl-3 text-center">{product.description}</DialogDescription>
        </DialogHeader>
          ...
          <div className="w-full md:w-3/5 pt-1 bg-white rounded-lg md:pl-4">
            ...
            <dl className="text-gray-900 pb-1">
              ...
              <div className="flex justify-between py-1 border-b">
                ...
                <dd className="text-md font-semibold">#{product.tokenId}</dd>
              </div>
              <div className="flex justify-between py-1">
                <dt className="text-gray-500 font-medium pr-6">Price (Wei)</dt>
                <dd className="text-md font-semibold">{product.priceInWei}</dd>
              </div>
            </dl>
